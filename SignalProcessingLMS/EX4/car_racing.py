...
class CarRacing(gym.Env, EzPickle):
    ...
    #actions_to_save = np.random.randint(0,255,size=(NUM_IMAGES_TO_SAVE, 3))
    #data_saved =0
    #quit = False
    #while not quit:
    #    env.reset()
    ...
    #      if any(a!=0):
    #            images_to_save[data_saved] = s
    #            actions_to_save[data_saved] = a
    #            data_saved +=1
    #            if data_saved == NUM_IMAGES_TO_SAVE-1:
    #                np.savez_compressed("car_Racing_Images", images_to_save)
    #                np.savez_compressed("car_Racing_Actions", actions_to_save)
    #                quit = True
    #        total_reward += r
...
#dict_data = np.load("car_Racing_Images.npz")
