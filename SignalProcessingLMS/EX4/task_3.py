...
from NeuralNetwork import NeuralNetwork_LSTM
...
model = NeuralNetwork_LSTM(input_size=96, sequence_length=SEQUENCE_LENGTH, num_layers=NUM_LAYERS,
...
custom_car_racing_test_dataloader = DataLoader(custom_car_racing_val_dataset, shuffle=False, batch_size=BATCH_SIZE)

model.assignFurther(train_loader=custom_car_racing_train_dataloader, val_loader=custom_car_racing_val_dataloader,
                    test_loader=custom_car_racing_test_dataloader, optimizer=optimizer,loss_fct=loss_crit)
