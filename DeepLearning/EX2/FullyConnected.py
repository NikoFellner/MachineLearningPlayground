...
class FullyConnected:
    ...
    def __init__(self, input_size, output_size):
        ...
        self.input_tensor = ''
        self.weights = np.random.uniform(0.0, 1.0, size=((self.input_size + 1), self.output_size))
    ...
    def forward(self, input_tensor):
        ...
        #transpose_output = np.dot(self.input_tensor, self.weights)
    ...
    def backward(self, error_tensor):
        ...
        #prev_error_tensor = np.dot(error_tensor, transpose_weight_tensor)
        ...
        #gradient_respect_weight = np.dot(transpose_input_tensor, error_tensor)
        ...
        if self.optimizer != '':
            updated_weights = self.optimizer.calculate_update(weight_tensor=self.weights, gradient_tensor=gradient_respect_weight)
